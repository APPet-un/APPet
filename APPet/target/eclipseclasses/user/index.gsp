		...
		<div id="list-user" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="telephone" title="${message(code: 'user.telephone.label', default: 'Telephone')}" />
					
						<g:sortableColumn property="mobilPhone" title="${message(code: 'user.mobilPhone.label', default: 'Mobil Phone')}" />
					
						<g:sortableColumn property="address" title="${message(code: 'user.address.label', default: 'Address')}" />
					
						<g:sortableColumn property="emailUser" title="${message(code: 'user.emailUser.label', default: 'Email User')}" />
