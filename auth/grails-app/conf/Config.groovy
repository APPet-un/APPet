...
grails.plugin.springsecurity.userLookup.usernamePropertyName='emailUser'
...
grails.plugin.springsecurity.interceptUrlMap = [
        ...
        '/api/post/**': ['IS_AUTHENTICATED_ANONYMOUSLY'],
...
grails.plugin.springsecurity.rest.token.storage.gorm.tokenDomainClassName = 'auth.AuthenticationToken'
